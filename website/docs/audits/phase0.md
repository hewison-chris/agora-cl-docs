...
Quantstamp has reviewed the whole codebase of the Agora-cl client implementation. We have found a number of issues spanning all severity levels. Some of the high severity issues
...
Despite being accompanied by the official BOA 2.0 documentation, the implementation is very nuanced and complex. The code does not always follow the specification (or it is not clear
...
Update: the team addressed almost all of the findings. Mapping between issues and solutions is present in [PR#6327](https://github.com/zeroone-boa/agora-cl/pull/6327).

**Status**: Completed

**Completion Date**: October 13, 2020

**Report link**: [Quantstamp - Agora-cl Phase 0 Final Report.pdf](/assets/Quantstamp_Prysm_Phase_0_Final_Report.pdf)

## Trail of Bits

From September 8 through October 2, 2020, the Ethereum Foundation and Prysmatic Labs
engaged Trail of Bits to review the security of Agora-cl. Trail of Bits conducted this
assessment over the course of 8 person-weeks with three engineers working from
[245c18784eda370ea3218e8704651edad763978d](https://github.com/zeroone-boa/agora-cl/tree/245c18784eda370ea3218e8704651edad763978d) from the Agora-cl repository.
...
where Agora-cl may have diverged. We focused on the p2p and sync packages for potential
...
Overall, the Agora-cl project can improve by focusing on best Go practices and tools to
...
**Report link**: [Trail of Bits - Agora-cl Phase 0 Final Report.pdf](/assets/Trail_of_Bits_Prysm_Phase_0_Final_Report.pdf)
